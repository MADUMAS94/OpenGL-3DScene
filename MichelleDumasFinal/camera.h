...
public:
    ...
    {
        //setting new movemeent speed based of yoffset
        float newMovementSpeed = yoffset > 0 ? MovementSpeed + 0.5 : MovementSpeed - 0.5;
        MovementSpeed = newMovementSpeed > 0 ? newMovementSpeed : 0.5;
    }
